...
namespace ChatApp
{
    ...
    */
    ...
    public static string SoftPrepare(string changedText)
    {
    ...
    */
    public static string Encipher(string key, string plainText)
    {
        ...
        for(int i = 0; i < length; i+=2)
        {
           ...
           if(a_row == b_row)//satırların eşit olması durumu
           {
              if(a_col == 4)
              {
            ...
            else if(a_col == b_col)//sutunların eşit olması durumu
            {
              if(a_row == 4)
              {
    ...
    */
    public static string Decipher(string key, string cipherText)
    {
        ...
        StringBuilder sb = new StringBuilder();
        int sayac = 0;
        for (sayac = 0; sayac < cipherText.Length; sayac++)
            if (cipherText[sayac] == '\0')
                break;
        for(int i = 0; i < sayac; i+=2)
        {
           a = cipherText[i];
           b = cipherText[i+1];
